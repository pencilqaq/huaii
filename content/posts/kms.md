...
1. 设置服务<br/>`slmgr -skms kms.huaii.top`
2. 安装密钥<br/>`slmgr -ipk 版本对应秘钥`
3. 激活系统<br/>`slmgr -ato`
...
2. 注册 KMS 服务 `cscript ospp.vbs /sethst:kms.huaii.top`
3. 激活 Office `cscript ospp.vbs /act`

- [Office 密钥列表](https://docs.microsoft.com/en-us/DeployOffice/vlactivation/gvlks)
...
| 操作系统版本                 | KMS 客户端安装密钥            |
| ---------------------------- | ----------------------------- |
| Windows IoT 企业版 LTSC 2021 | KBN8V-HFGQ4-MGXVD-347P6-PDQGT |
